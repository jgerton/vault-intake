...
| Orchestrator (dry-run) | Implemented (fixed_domains end-to-end; emergent-mode runs degrade gracefully via NotImplementedError catch with full Steps 3-6 cascade surfaced as questions; file writes and CLI wrapper not yet) |
